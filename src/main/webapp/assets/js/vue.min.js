Vue.config.ignoredElements="grid gbody ghead gfoot gr gd gh".split(" ");Vue.component("base-layout",vueLoader("layouts/baseLayout"));Vue.component("grid-layout",vueLoader("layouts/gridLayout"));Vue.component("modal-layout",vueLoader("layouts/modalLayout"));Vue.component("tabs-layout",vueLoader("layouts/tabsLayout"));Vue.component("institution-select",vueLoader("components/widgets/institutionSelect"));Vue.component("tooltip",vueLoader("components/widgets/tooltip"));Vue.component("search-box",vueLoader("components/widgets/searchBox"));

...
d.proposedTags.find(b=>b.value===d.tags[a].value),void 0!==c&&(d.tags[a]=c)}for(var e in f)void 0!==a[e]&&(d[e]=this.createOrUpdate(a[e],f[e][0]),f[e][1]&&(b=d[e][f[e][1]],b.includes(d)||b.push(d)));for(var h in k)if(void 0!==a[h]&&a[h]&&0<a[h].length)for(d[h].splice(0,d[h].length),a[h].sort((a,b)=>a.id-b.id),f=a[h].length,e=0;e<f;e++)b=this.createOrUpdate(a[h][e],k[h][0]),d[h].includes(b)||d[h].push(b),k[h][1]&&(b[k[h][1]]=d);for(let b in n)if(void 0!==a[b]&&a[b]&&0<a[b].length)for(d[b].splice(0,
...
this.Notifications.readAll=function(a={}){a.method="PUT";this.call(a)}};